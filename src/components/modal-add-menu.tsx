...
const ModalAddMenu: FC = () => {
  ...
  const { createMenu, fetchListMenu, isCreating } = useMenuStore();
  ...
  return (
    <>
      <div
        ...
        aria-expanded="false"
        aria-controls="modal_add_menu"
        data-overlay="#modal_add_menu"
      >
        <button className="btn btn-soft btn-warning">Create New Data</button>
      </div>
